...
const AccordionItem = ({ info }) => {
    ...
    return (
        (info && info.title) && <div className={styles.container}>
            {
                <div ref={parent}>
                    <div className={styles.topContainer}>
                        ...
                        <div className={dropDown ? styles.dropDownBtnContainerActive : styles.dropDownBtnContainer}>
