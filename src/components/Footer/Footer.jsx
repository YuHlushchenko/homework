  ...
  return (
    <div className={styles.footerContainer}>
      <div className={styles.topContainer}>
        <div className={styles.topLeftContainer}>
          ...
          <div className={styles.aboutUsContainer}>
            <span>про нас</span>
            <p>
              Lorem ipsum dolor sit amet. Est voluptatem dolorem sed obc em
              ipsum dolor sit amet. Est voluptatem dolorem sedem ipsum dolor sit
              amet. Est voluptatem dolorem sed obc
            </p>
          </div>
        </div>
        ...
        <div className={styles.topRightContainer}>
          ...
          <div className={styles.contactInfoContainer}>
            ...
            <div className={styles.addressContainer}>
              <a
                href="https://goo.gl/maps/3hDCgabCxnpcQowQA"
                target="_blank"
                rel="noreferrer">
      ...
      <div className={styles.bottomContainer}>
        ...
        <a href="/#">Політика конфеденціності</a>
      </div>
    </div>
  )
}
