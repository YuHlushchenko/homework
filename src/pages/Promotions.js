  ...
  const promotions = [
    {
      ...
      discount: ' - 50%',
      date: '30.09.2021',
      details: 'При замовленні ремонту в компанії Свої Стіни - діє знижка 50% на монтаж системи Розумного Будинку',
    },

    {
      ...
      discount: '',
      date: '30.09.2021',
      details: 'При замовленні ремонту в компанії "Свої Стіни" - дизайн проект в подарунок',
    },
  ]
    ...
    <>
      <section className={styles.promotionsSectionContainer}>
        <div className={styles.titleContainer}>
          ...
          <p>Ми намагаємося, щоб співпраця кожного клієнта з нашою компанією <br /> була максимально приємна і вигідна.</p>
        </div>
        ...
        <div className={styles.promotionBlocksContainer}>
          {
            promotions.map((item, index) => {
              return (
                <div
                  className={styles.promtionItemContainer}
                  key={index}
                >
                  <PromotionItem
                    imgSrc={item.imgSrc}
