...
const item = {
  ...
  imgUrl: '/designRepairImgs/img1.webp',
  text1:
...
const portfolio = {
  title: 'портфоліо',
  imgSrcs: [
    '/designRepairImgs/portfolio/img1.webp',
    '/designRepairImgs/portfolio/img2.webp',
    '/designRepairImgs/portfolio/img3.webp',
    '/designRepairImgs/portfolio/img4.webp',
    '/designRepairImgs/portfolio/img5.webp',
    '/designRepairImgs/portfolio/img6.webp',
    '/designRepairImgs/portfolio/img1.webp',
    '/designRepairImgs/portfolio/img2.webp',
    '/designRepairImgs/portfolio/img3.webp',
    '/designRepairImgs/portfolio/img4.webp',
...
const table = {
  ...
  description:
    'Коли дизайн-проект буде узгоджено та затверджено бюджет - починаються роботи з ремонту. Вони складаються з наступних основних етапів:',
    ...
    <PageWrapper>
      <div className={styles.designRepairContainer}>
        ...
        <div className={styles.textContainer}>
          ...
          <p>
            Майже неможливо сказати точно, скільки коштуватиме дизайнерський
            ремонт квартири. Зазвичай вартість залежить від різних критеріїв. В
            принципі можна отримати не дуже дорогий дизайнерський ремонт у
            маленькому житлі. Такий варіант може бути реалізований тоді, коли не
            замовляються дорогі матеріали та меблі і не потрібно повністю міняти
            планування, особливо з демонтажем несучих конструкцій.
          </p>
          <p>
            У тих, хто має велику квартиру, бажає зробити її повністю унікальною
            та ексклюзивною, ремонт обійдеться у чималу суму. Якщо ви хочете
            приблизно дізнатися, скільки складе вартість оздоблювальних
            матеріалів та меблів, фахівці нашої компанії підберуть вам
            відповідні варіанти та розрахують орієнтовний бюджет.
          </p>
        </div>
      </div>
    </PageWrapper>
